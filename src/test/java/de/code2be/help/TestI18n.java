...
class TestI18n extends I18nTestSuper
{

    @Test
    void testGetMessageClassOfQStringObjectArray()
    {
        assertEquals(I18n.getMessage(TestI18n.class, "main.test3.value", 10),
                "This is for one param: 10.");
        assertEquals(I18n.getMessage(TestI18n.class, "main.test4.value", 10, 20,
                "Hello"), "This is for three params: 10 - Hello - 20.");
        assertEquals(I18n.getMessage(TestI18n.class, "main.super.test1.value"),
                "This value overwrites I18nTestSuperSuper and is from I18nTestSuper");
        assertEquals(I18n.getMessage(TestI18n.class, "main.super.test2.value"),
                "This value is only in I18nTestSuperSuper");
        assertEquals(I18n.getMessage(TestI18n.class, "main.super.test3.value"),
                "This value is only in I18nTestSuper");

        MissingResourceException ex = Assertions
                .assertThrows(MissingResourceException.class, () -> {
                    I18n.getMessage(TestI18n.class,
    ...
    {
        assertEquals(
                I18n.getMessage(TestI18n.class.getName(), "main.test1.value"),
                "This is the value of test 1.");
        assertEquals(
                I18n.getMessage(TestI18n.class.getName(), "main.test2.value"),
    ...
    {
        assertEquals(I18n.getMessage(TestI18n.class.getName(),
        ...
        assertEquals(
                I18n.getMessage(TestI18n.class.getName(), "main.test4.value",
                        10, 20, "Hello"),
