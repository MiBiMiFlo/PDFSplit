 ...
 * 
 * @author Babu Kalakrishnan Modifications by greearb and jzd Taken from
 *         https://stackoverflow.com/questions/3679886/how-can-i-let-jtoolbars-wrap-to-the-next-line-flowlayout-without-them-being-hi
 */
public class FlowWrapLayout2 extends FlowLayout
{

    private static final long serialVersionUID = -5449703604989186338L;

    public FlowWrapLayout2()
    {
        super();
    }


    public FlowWrapLayout2(int align)
    {
        super(align);
    }


    public FlowWrapLayout2(int align, int hgap, int vgap)
    {
